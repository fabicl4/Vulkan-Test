...
// TODO: Change to match my architecture
...
// There are 2 types of pipeline in Vulkan: Grpahics and Compute pipelines
...
public:
    ...
    {
        createGraphicsPipeline(vsCode, fsCode, pipelineInfo);
    }
    ...
    static PipelineConfigInfo defaultPipelineConfigInfo(uint32_t width, uint32_t height) {
        ...
        configInfo.bindingDescription = Vertex::getBindingDescription();
...
private:
    ...
    void createGraphicsPipeline(
        const std::vector<char>& vsCode,
        const std::vector<char>& fsCode,
        const PipelineConfigInfo& configInfo) {

        createShaderModule(vsCode, &m_vsModule);
        createShaderModule(fsCode, &m_fsModule);

        VkPipelineShaderStageCreateInfo vertShaderStageInfo{};
        vertShaderStageInfo.sType = VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_CREATE_INFO;
        vertShaderStageInfo.stage = VK_SHADER_STAGE_VERTEX_BIT;
        vertShaderStageInfo.module = m_vsModule;
        vertShaderStageInfo.pName = "main";

        VkPipelineShaderStageCreateInfo fragShaderStageInfo{};
        fragShaderStageInfo.sType = VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_CREATE_INFO;
        fragShaderStageInfo.stage = VK_SHADER_STAGE_FRAGMENT_BIT;
        fragShaderStageInfo.module = m_fsModule;
        ...
        vertexInputInfo.pVertexBindingDescriptions = &configInfo.bindingDescription;
