...
#include <renderer/types/Pipeline.h>
...
//#include <renderer/resources/BufferAllocator.h>
...
// Pass is a small wrapper that owns a Vulkan render pass, its framebuffers,
...
class RenderPass {
public:
    explicit RenderPass(core::Context ctx) : m_ctx(ctx) {};
